...
async def init_database():
    ...
    try:
        ...
        from .SpeedDial import SpeedDialDB
        ...
        speed_dial_db = SpeedDialDB(async_db)
        ...
        await speed_dial_db.init_indexes()
