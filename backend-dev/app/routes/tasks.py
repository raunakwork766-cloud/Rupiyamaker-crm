...
async def search_leads_for_task(
    ...
    try:
        ...
        # Check if user has 'all' level access to leads (accept both 'all' and 'view_all')
...
async def get_filter_options(
    ...
    try:
        ...
        # Check if user has junior/view_team permission
        has_view_junior = any(
            (perm.get("page") in ["tasks", "*", "any"] and 
             (perm.get("actions") == "*" or 
              perm.get("actions") == "view_team" or
              (isinstance(perm.get("actions"), list) and 
               ("*" in perm.get("actions") or "view_team" in perm.get("actions") or "view_team" in perm.get("actions")))))
            for perm in user_permissions
        )
