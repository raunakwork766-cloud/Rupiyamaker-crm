...
async def get_permission_structure(
    ...
    permission_structure = {
        ...
        "Leads": ["create", "show", "assign", "own", "view_other", "all", "view_team"],
        "Login": ["show", "own", "view_other", "all", "view_team"],
        "Tasks": ["show", "create", "edit_others"],
        "Tickets": ["show", "own", "view_team"],
        "HRMS Employees": ["show", "edit", "create", "delete", "all_employees"],
        "Leaves": ["show", "own", "admin", "create", "view_team", "edit"],
        "Attendance": ["show", "own", "admin", "edit", "mark", "view_team"],
