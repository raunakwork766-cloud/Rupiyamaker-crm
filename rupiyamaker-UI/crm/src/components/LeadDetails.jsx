...
export default function LeadDetails({ lead, user, onBack, onLeadUpdate, readOnly = false, obligationsReadOnly = false, allowedTabs = null, saveContext }) {
    ...
    return (
        <div className={activeTab === 'obligations' ? (effectiveReadOnly ? 'flex flex-col bg-black text-white pt-2 px-2 pb-0' : 'h-screen overflow-hidden bg-black text-white flex flex-col pt-2 px-2 pb-0') : 'flex h-screen bg-black text-white overflow-hidden'}>
