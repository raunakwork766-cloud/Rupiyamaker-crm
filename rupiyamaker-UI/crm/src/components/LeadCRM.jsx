...
const LeadCRM = memo(function LeadCRM({ user, selectedLoanType: initialLoanType, department = "leads" }) {
    ...
    if (selectedLead) {
        ...
        return (
            <div className={activeTab === 1 ? 'h-screen overflow-hidden bg-black text-white text-base flex flex-col' : 'h-screen overflow-hidden bg-black text-white text-base flex flex-col'} style={activeTab === 1 ? {fontSize:'90%'} : {}}>
                {/* Header */}
                ...
                <div className={activeTab === 1 ? 'flex-1 min-h-0 w-full overflow-hidden' : 'flex flex-1 min-h-0 overflow-hidden'}>
                    <div className={activeTab === 1 ? 'w-full h-full' : 'flex-1 overflow-y-auto px-2 sm:px-4 lg:px-6 py-6'}>
