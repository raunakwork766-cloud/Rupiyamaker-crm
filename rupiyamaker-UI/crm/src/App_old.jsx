...
import { getRouteByLabel } from './utils/navigation'
...
export default App
      case "Ticket":
        return <TicketPage user={user} />;
      case "PL & ODD LOGIN":
        return <AllPlOddLeads user={user} />;
      case "Home Loan LOGIN":
        return <AllHomeLoan user={user} />;
      case "Task":
        return <Task user={user} />;
      case "Employees":
      case "All Employees":
        return <AllEmployees user={user} />;
      case "All Leave":
      ...
      case "Warning":
      case "Warning Dashboard":
      case "All Warnings":
      case "My Warnings":
        return <WarningPage user={user} />;
      case "Add Task":
        return <AddTask user={user} />;
      case "Settings":
        return <SettingsPage user={user} />;
      default:
        return <div className="p-6 text-white">No component found</div>;
    }
  };
